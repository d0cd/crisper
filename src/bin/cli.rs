use crisper::{client, DEFAULT_PORT};
...
#[structopt(name = "crisper-cli", version = env!("CARGO_PKG_VERSION"), author = env!("CARGO_PKG_AUTHORS"), about = "Issue Redis commands")]
struct Cli {
