...
# TODO: Remove all non LWW stuff

from crisper.lattice_pb2 import (
...
#from crisper.causal_pb2 import CausalTuple
from crisper.lattices import (
    Lattice,
    LWWPairLattice,
    ListBasedOrderedSet,
    MapLattice,
...
class BaseCrisperClient():
    ...
    # Takes a KeyTuple (defined in hydro-project/common/proto/crisper.proto) as an
    ...
    # hydro-project/common/proto/crisper.proto). Takes in a key name and returns a
